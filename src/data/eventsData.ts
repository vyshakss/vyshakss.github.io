...
const RAW_EVENTS_DATA: EventDetail[] = [
  ...
  },
  {
    ...
    "rules": [
      ...
      "Maximum weight 10kgs (including battery).",
      "Maximum dimensions 300 x 300 x 400 mm (Length x Breadth x Height).",
      "Control: Wireless (remote control) ONLY.",
      "Power source: Battery 24V max. Battery must be commercially manufactured with proper protection, and only 1 battery is permitted in the bot, not more than 1.",
      "Match duration: 3-5 minutes.",
      "No projectiles, explosives, flames, liquids or hazardous chemicals."
    ],
    "faqs": [],
    "prizePool": "22K",
    "date": "15-16 Sept 2026",
